...
The [Lua SDK](https://github.com/) is a Datalink RESTful Service wrapper, the Lua SDK provides a minimal & efficient way to interface with the Datalink Service. 

> RESTful APIs

The [RESTful API](https://github.com/) are the backend to the Datalink service, if you've chosen to write your own wrapper/module for the Datalink service, then taking advantage of these
APIs will be of interest.
